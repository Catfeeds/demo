...
class Common_util_pub
{
	...
	function __construct($version) {
		$this->wxpay_config = wxpay_config($version);
	}
...
class Wxpay_client_pub extends Common_util_pub 
{
	...
	function createXml()
	{
	   	...
	   	$this->parameters["mch_id"] = $this->wxpay_config['mch_id'];//商户号
...
class NativeCall_pub extends Wxpay_server_pub
{
	...
	function createXml()
	{
		if($this->returnParameters["return_code"] == "SUCCESS"){
		   	$this->returnParameters["appid"] = $this->wxpay_config['appid'];//公众账号ID
		   	$this->returnParameters["mch_id"] = $this->wxpay_config['mch_id'];//商户号
