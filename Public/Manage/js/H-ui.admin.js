...
function stop(url) {
    ...
    layer.confirm('确认要停用吗？', function (index) {
        $.get(url,{id:tmp},function (data) {
            ...
            /*if(data.status == 1){
                $(obj).parents("tr").find(".td-manage").prepend('<a onClick=\'start(this,"'+url+'")\' href="javascript:;" title="启用" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>');
